...
- **Plain English and German descriptions**, written from public sources, on every enriched code (currently 4,225 — growing wave by wave toward full coverage).
...
| **Generic total** |**9,533**| **4,225 enriched + 5,308 indexed** |
